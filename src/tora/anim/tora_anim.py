...
from tora.anim import ToraVis, ToraVisPar, get_view_box
...
class ToraAnim(AnimatorObject):
  def __init__(self, ax : Axes, par : ToraVisPar, traj : Trajectory):
    self.__model = ToraVis(ax, par)
